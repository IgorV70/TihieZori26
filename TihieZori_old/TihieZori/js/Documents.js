class CTable {
    ...
    Init() {
        $.getJSON('head/Documents.dbo', headline => {
            $.getJSON('data/Documents.dbo', data => {
                var s1 = $(".s1");
                s1.hide();
                var head = this.head;
        ...
        this.Actions = {
            ...
            del: row => {
                ...
                if (this.BeforeDelete(data)) {
                    $.getJSON('del/Documents.dbo', { "Id": data[this.head["Id"]] }, () => {
                        row.remove();
                    });
                };
            },
...
var docTable = new CTable({ saveurl: 'edit/Documents.dbo' });
